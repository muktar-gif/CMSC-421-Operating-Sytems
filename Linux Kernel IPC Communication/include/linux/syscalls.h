...
asmlinkage long sys_reset_mbox_421(void);
asmlinkage long sys_count_mbox_421(void);
asmlinkage long sys_list_mbox_421(unsigned long __user *mbxes, long k);
asmlinkage long sys_send_msg_421(unsigned long id, const unsigned char __user *msg, long n);
asmlinkage long sys_recv_msg_421(unsigned long id, unsigned char __user *msg, long n);
asmlinkage long sys_peek_msg_421(unsigned long id, unsigned char __user *msg, long n);
asmlinkage long sys_count_msg_421(unsigned long id);
asmlinkage long sys_len_msg_421(unsigned long id);
asmlinkage long sys_print_mbox_421(unsigned long id);
